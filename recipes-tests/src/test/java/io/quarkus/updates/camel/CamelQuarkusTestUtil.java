...
public class CamelQuarkusTestUtil {
    ...
    public static RecipeSpec recipe3_25(RecipeSpec spec, String... activeRecipes) {
        return recipeForVersion("3.25", spec, activeRecipes);
    }

    public static RecipeSpec recipe3_26(RecipeSpec spec, String... activeRecipes) {
        return recipeForVersion("3.26", spec, activeRecipes);
    }

    public static RecipeSpec recipe3_29(RecipeSpec spec, String... activeRecipes) {
        return recipeForVersion("3.29", spec, activeRecipes);
    }

    public static RecipeSpec recipe3_30(RecipeSpec spec, String... activeRecipes) {
        return recipeForVersion("3.30", spec, activeRecipes);
    }

    public static RecipeSpec recipe3_31(RecipeSpec spec, String... activeRecipes) {
        return recipeForVersion("3.31", spec, activeRecipes);
    }

    public static RecipeSpec recipe3_32(RecipeSpec spec, String... activeRecipes) {
        return recipeForVersion("3.32", spec, activeRecipes);
    }

    public static RecipeSpec recipe3_33(RecipeSpec spec, String... activeRecipes) {
        return recipeForVersion("3.33", spec, activeRecipes);
    }
    ...
    private static RecipeSpec recipe(RecipeSpec spec, String version) {
        String[] defaultRecipes = switch (version) {
            ...
            case "3.25" -> new String[] {"io.quarkus.updates.camel.camel413.CamelQuarkusMigrationRecipe"};
            case "3.26" -> new String[] {"io.quarkus.updates.camel.camel414.CamelQuarkusMigrationRecipe"};
            case "3.29" -> new String[] {"io.quarkus.updates.camel.camel415.CamelQuarkusMigrationRecipe"};
            case "3.30" -> new String[] {"io.quarkus.updates.camel.camel416.CamelQuarkusMigrationRecipe"};
            case "3.31" -> new String[] {"io.quarkus.updates.camel.camel417.CamelQuarkusMigrationRecipe"};
            case "3.32" -> new String[] {"io.quarkus.updates.camel.camel418.CamelQuarkusMigrationRecipe"};
            case "3.33" -> new String[] {"io.quarkus.updates.camel.camel419.CamelQuarkusMigrationRecipe"};
