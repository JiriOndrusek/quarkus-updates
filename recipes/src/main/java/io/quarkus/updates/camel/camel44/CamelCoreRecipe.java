...
public class CamelCoreRecipe extends Recipe {
    ...
    private static final String M_EXPRESSION_CAUSE_XQUERY3 = "org.apache.camel.builder.ExpressionClause xquery(java.lang.String, java.lang.Class, org.apache.camel.support.builder.Namespaces, java.lang.String)";
        ...
        return new AbstractCamelQuarkusJavaVisitor() {
            ...
            protected J.MethodInvocation doVisitMethodInvocation(J.MethodInvocation method, ExecutionContext context) {
                ...
                if (getMethodMatcher(M_EXCHANGE_GET_CREATED).matches(mi, false)) {
                    ...
                    /*.new J.Identifier(UUID.randomUUID(), mi.getPrefix(), Markers.EMPTY, Collections.emptyList(),
                                    "/* Method '" + mi.getSimpleName() + "(' has been removed as a part of making the DSL model consistent.\n" +
                                            "See https://camel.apache.org/manual/camel-4x-upgrade-guide-4_4.html#_camel_core for more details.\"", mi.getType(), null));


*/
//                            .withComments(Collections.singletonList(RecipesUtil.createComment(
